...
exports.AbstractSdkLedgerCustomerService = void 0;
const tslib_1 = require("tslib");
const api_client_1 = require("@tatumio/api-client");
// @TODO remove after OPENAPI change
class AbstractSdkLedgerCustomerService {
    constructor() {
        this.getCustomer = api_client_1.CustomerService.getCustomerByExternalOrInternalId;
        this.getAllCustomers = api_client_1.CustomerService.findAllCustomers;
        this.updateCustomer = api_client_1.CustomerService.updateCustomer;
        this.activateCustomer = api_client_1.CustomerService.activateCustomer;
        this.deactivateCustomer = api_client_1.CustomerService.deactivateCustomer;
        this.enableCustomer = api_client_1.CustomerService.enableCustomer;
        this.disableCustomer = api_client_1.CustomerService.disableCustomer;
...
exports.AbstractSdkLedgerCustomerService = AbstractSdkLedgerCustomerService;
//# sourceMappingURL=ledger.customer.abstract.js.map