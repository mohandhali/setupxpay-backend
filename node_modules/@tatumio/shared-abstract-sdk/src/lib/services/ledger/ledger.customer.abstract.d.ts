import { Account, AccountService, Address, CreateAccountXpub, CustomerService, Wallet } from '@tatumio/api-client';
...
export declare class AbstractSdkLedgerCustomerService {
    getCustomer: typeof CustomerService.getCustomerByExternalOrInternalId;
    getAllCustomers: typeof CustomerService.findAllCustomers;
    updateCustomer: typeof CustomerService.updateCustomer;
    activateCustomer: typeof CustomerService.activateCustomer;
    deactivateCustomer: typeof CustomerService.deactivateCustomer;
    enableCustomer: typeof CustomerService.enableCustomer;
    disableCustomer: typeof CustomerService.disableCustomer;
     ...
     */
    static generateAccount(account: CreateAccountXpub, generateNewWalletFn: GenerateWalletFn, generateNewWallet?: boolean, testnet?: boolean, webhookUrl?: string): Promise<GeneratedAccount>;
}
