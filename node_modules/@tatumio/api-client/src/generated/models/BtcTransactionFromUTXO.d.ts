import type { BtcTransactionFromUTXOSource } from './BtcTransactionFromUTXOSource';
import type { BtcTransactionFromUTXOTarget } from './BtcTransactionFromUTXOTarget';
export declare type BtcTransactionFromUTXO = {
    /**
