...
export declare class BnbSmartChainService {
    /**
     * Generate BSC wallet
     ...
     * @throws ApiError
     */
    static bscGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static bscGenerateAddress(xpub: string, index: number): CancelablePromise<GeneratedAddressBsc>;
    /**
     ...
     * @throws ApiError
     */
    static bscGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     * @deprecated
     * Web3 HTTP driver
     ...
     * @throws ApiError
     */
    static bscWeb3Driver(xApiKey: string, requestBody: any): CancelablePromise<any>;
    /**
     ...
     * @throws ApiError
     */
    static bscGetCurrentBlock(): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static bscGetBlock(hash: string): CancelablePromise<EthBlock>;
    /**
     ...
     * @throws ApiError
     */
    static bscGetBalance(address: string): CancelablePromise<BscBalance>;
    /**
     * Get BSC Transaction
     * <p><b>2 credits per API call</b></p>
     ...
     * @throws ApiError
     */
    static bscGetTransaction(hash: string): CancelablePromise<BscTx>;
    /**
     ...
     * @throws ApiError
     */
    static bscGetTransactionCount(address: string): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static bscBlockchainTransfer(requestBody: (TransferBscBlockchain | TransferBscBlockchainKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static bscBlockchainSmartContractInvocation(requestBody: (CallBscSmartContractReadMethod | CallBscSmartContractMethod | CallBscSmartContractMethodCaller | CallBscSmartContractMethodKMS)): CancelablePromise<(TransactionHash | SignatureId | Data)>;
    /**
     ...
     * @throws ApiError
     */
    static bscBroadcast(requestBody: BroadcastKMS): CancelablePromise<TransactionHash>;
}
