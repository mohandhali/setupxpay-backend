...
export declare class AvalancheService {
    /**
     ...
     * @throws ApiError
     */
    static avalancheGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static avalancheGenerateAddress(xpub: string, index: number): CancelablePromise<GeneratedAddressAvalanche>;
    /**
     ...
     * @throws ApiError
     */
    static avalancheGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     * @deprecated
     * Web3 HTTP driver
     ...
     * @throws ApiError
     */
    static avalancheWeb3Driver(xApiKey: string, requestBody: any): CancelablePromise<any>;
    /**
     ...
     * @throws ApiError
     */
    static avalancheGetCurrentBlock(): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static avalancheGetBlock(hash: string): CancelablePromise<AvalancheBlock>;
    /**
     ...
     * @throws ApiError
     */
    static avalancheGetBalance(address: string): CancelablePromise<AvalancheBalance>;
    /**
     ...
     * @throws ApiError
     */
    static avalancheGetTransaction(hash: string): CancelablePromise<AvalancheTx>;
    /**
     ...
     * @throws ApiError
     */
    static avalancheGetTransactionCount(address: string): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static avalancheBlockchainTransfer(requestBody: (TransferAvalancheBlockchain | TransferAvalancheBlockchainKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static avalancheBlockchainSmartContractInvocation(requestBody: (CallSmartContractMethod | CallReadSmartContractMethod | CallAvalancheSmartContractMethodCaller | CallSmartContractMethodKMS)): CancelablePromise<(TransactionHash | SignatureId | Data)>;
    /**
     ...
     * @throws ApiError
     */
    static avalancheBroadcast(requestBody: BroadcastKMS): CancelablePromise<TransactionHash>;
}
