...
export declare class TronService {
     ...
     * @throws ApiError
     */
    static tronAccountTx(address: string, next?: string, onlyConfirmed?: boolean, onlyUnconfirmed?: boolean, onlyTo?: boolean, onlyFrom?: boolean, orderBy?: 'block_timestamp,asc' | 'block_timestamp,desc', minTimestamp?: number, maxTimestamp?: number): CancelablePromise<{
        /**
     ...
     * @throws ApiError
     */
    static tronAccountTx20(address: string, next?: string, onlyConfirmed?: boolean, onlyUnconfirmed?: boolean, onlyTo?: boolean, onlyFrom?: boolean, orderBy?: 'block_timestamp,asc' | 'block_timestamp,desc', minTimestamp?: number, maxTimestamp?: number, contractAddress?: string): CancelablePromise<{
        /**
         * If present, there are more transactions for the TRON account than the 200 transactions returned in the response, and this parameter specifies the fingerprint of the transaction that follows the last (200<sup>th</sup>) transaction in the returned list of transactions. Use it to get the next 200 transactions for the specified account (for more information, see the description of this API).
         */
        next?: string;
