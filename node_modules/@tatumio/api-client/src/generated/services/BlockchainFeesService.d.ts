...
export declare class BlockchainFeesService {
     ...
     * @throws ApiError
     */
    static flareEstimateGas(requestBody: FlareEstimateGas): CancelablePromise<GasEstimated>;
    /**
     ...
     * @throws ApiError
     */
    static cronosEstimateGas(requestBody: CronosEstimateGas): CancelablePromise<GasEstimated>;
    /**
     ...
     * @throws ApiError
     */
    static avalancheEstimateGas(requestBody: AvalancheEstimateGas): CancelablePromise<GasEstimated>;
    /**
     * Estimate the fee for a Cronos transaction
     * <p><b>2 credits per API call</b></p>
     ...
     * @throws ApiError
     */
    static baseEstimateGas(requestBody: BaseEstimateGas): CancelablePromise<GasEstimated>;
    /**
     * Estimate the fee for a Cronos transaction
     * <p><b>2 credits per API call</b></p>
     * <p>Get an estimated gas price and the number of gas units needed for a Base transaction.</p>
     ...
     * @throws ApiError
     */
    static sonicEstimateGas(requestBody: SonicEstimateGas): CancelablePromise<GasEstimated>;
    /**
     ...
     * @throws ApiError
     */
    static optimismEstimateGas(requestBody: OptimismEstimateGas): CancelablePromise<GasEstimated>;
    /**
