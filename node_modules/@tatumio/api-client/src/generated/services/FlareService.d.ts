...
export declare class FlareService {
    /**
     ...
     * @throws ApiError
     */
    static flareGenerateWallet(mnemonic?: string, testnetType?: FlareTestnetType, xTestnetType?: FlareTestnetType): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static flareGenerateAddress(xpub: string, index: number, testnetType?: FlareTestnetType, xTestnetType?: FlareTestnetType): CancelablePromise<GeneratedAddressFlare>;
    /**
     ...
     * @throws ApiError
     */
    static flareGenerateAddressPrivateKey(requestBody: PrivKeyRequest, testnetType?: FlareTestnetType, xTestnetType?: FlareTestnetType): CancelablePromise<PrivKey>;
    /**
     * @deprecated
     * Web3 HTTP driver
     ...
     * @throws ApiError
     */
    static flareWeb3Driver(xApiKey: string, requestBody: any, testnetType?: FlareTestnetType, xTestnetType?: FlareTestnetType): CancelablePromise<any>;
    /**
     ...
     * @throws ApiError
     */
    static flareGetCurrentBlock(testnetType?: FlareTestnetType, xTestnetType?: FlareTestnetType): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static flareGetBlock(hash: string, testnetType?: FlareTestnetType, xTestnetType?: FlareTestnetType): CancelablePromise<FlareBlock>;
    /**
     ...
     * @throws ApiError
     */
    static flareGetBalance(address: string, testnetType?: FlareTestnetType, xTestnetType?: FlareTestnetType): CancelablePromise<FlareBalance>;
    /**
     ...
     * @throws ApiError
     */
    static flareGetTransaction(hash: string, testnetType?: FlareTestnetType, xTestnetType?: FlareTestnetType): CancelablePromise<FlareTx>;
    /**
     ...
     * @throws ApiError
     */
    static flareGetTransactionCount(address: string, testnetType?: FlareTestnetType, xTestnetType?: FlareTestnetType): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static flareBlockchainTransfer(requestBody: (TransferFlareBlockchain | TransferFlareBlockchainKMS), testnetType?: FlareTestnetType, xTestnetType?: FlareTestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static flareBlockchainSmartContractInvocation(requestBody: (CallSmartContractMethod | CallReadSmartContractMethod | CallFlareSmartContractMethodCaller | CallSmartContractMethodKMS), testnetType?: FlareTestnetType, xTestnetType?: FlareTestnetType): CancelablePromise<(TransactionHash | SignatureId | Data)>;
    /**
     ...
     * @throws ApiError
     */
    static flareBroadcast(requestBody: BroadcastKMS, testnetType?: FlareTestnetType, xTestnetType?: FlareTestnetType): CancelablePromise<TransactionHash>;
}
