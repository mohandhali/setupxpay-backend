...
class NftErc721OrCompatibleService {
     ...
     * @throws ApiError
     */
    static nftDeployErc721(requestBody, testnetType, xTestnetType) {
     ...
     * @throws ApiError
     */
    static nftAddMinter(requestBody, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * {
         ...
         * {
             ...
             * @throws ApiError
             */
    static nftMintErc721(requestBody, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/nft/mint`,
            headers: {
     ...
     * @throws ApiError
     */
    static nftTransferErc721(requestBody, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * <pre>{
         ...
         * @throws ApiError
         */
    static nftMintMultipleErc721(requestBody, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static nftBurnErc721(requestBody, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/nft/burn`,
            headers: {
     ...
     * @throws ApiError
     */
    static nftGetTransactErc721(chain, hash, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static nftGetBalanceErc721(chain, address, contractAddress, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static nftGetMetadataErc721(chain, contractAddress, tokenId, account, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'GET',
