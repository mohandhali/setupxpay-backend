...
export declare class LitecoinService {
     ...
     * @throws ApiError
     */
    static ltcGetTxByAddress(address: string, pageSize: number, offset?: number, blockFrom?: number, blockTo?: number, txType?: 'incoming' | 'outgoing'): CancelablePromise<Array<LtcTx>>;
    /**
