...
export declare class SonicTatumApiService {
     ...
     * @returns GeneratedAddressSonic OK
     * @throws ApiError
     */
    static sonicGenerateAddress(xpub: string, index: number): CancelablePromise<GeneratedAddressSonic>;
    /**
     ...
     * @throws ApiError
     */
    static sonicGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     * @deprecated
     * Web3 HTTP driver
     ...
     * <p>Use this endpoint URL as an http-based web3 driver to connect directly to the Sonic node provided by Tatum.
     * To learn more about Sonic Web3, visit the <a href="https://sonic.network/" target="_blank">Sonic developers' guide</a>.</p>
     *
     ...
     * @throws ApiError
     */
    static sonicWeb3Driver(xApiKey: string, requestBody: any): CancelablePromise<any>;
    /**
     * Get current block number
     * <h4>1 credit per API call.</h4><br/><p>Gets the current Sonic block number. This is the number of the latest block in the blockchain.</p>
     * @returns number OK
     * @throws ApiError
     */
    static sonicGetCurrentBlock(): CancelablePromise<number>;
    /**
     * Get Sonic block by hash
     * <h4>1 credit per API call.</h4><br/><p>Gets an Sonic block-by-block hash or block number.</p>
     * @param hash Block hash or block number
     * @returns SonicBlock OK
     * @throws ApiError
     */
    static sonicGetBlock(hash: string): CancelablePromise<SonicBlock>;
    /**
     * Get the S balance of an Sonic account
     * <p><b>1 credit per API call</b></p>
     * <p>Get the balance of <b>S</b> of an Sonic account.</p>
     ...
     * @returns SonicBalance OK
     * @throws ApiError
     */
    static sonicGetBalance(address: string): CancelablePromise<SonicBalance>;
    /**
     * Get Sonic Transaction
     * <p><b>1 credit per API call</b></p>
     * <p>Get Sonic transaction by transaction hash.</p>
     *
     * @param hash Transaction hash
     * @returns SonicTx OK
     * @throws ApiError
     */
    static sonicGetTransaction(hash: string): CancelablePromise<SonicTx>;
    /**
     * Get count of outgoing Sonic transactions
     * <h4>1 credit per API call.</h4><br/>
     * <p>Get a number of outgoing Sonic transactions for the address. When a transaction is sent, there can be multiple outgoing transactions,
     ...
     * @throws ApiError
     */
    static sonicGetTransactionCount(address: string): CancelablePromise<number>;
    /**
     * Send S or fungible tokens (ERC-20) from account to account
     * <p><b>2 credits per API call</b></p>
     * <p>Send S or Tatum-supported fungible tokens (ERC-20) from account to account.</p>
     * <p style="border:4px solid DeepSkyBlue;"><b>NOTE:</b> Sending the fungible tokens is supported only on the mainnet.</p>
     * <p><b>Signing a transaction</b><br/>
     * When sending S, you are charged a fee for the transaction, and you must sign the transaction with the private key of the blockchain address from which the fee will be deducted.</p>
     ...
     * @throws ApiError
     */
    static sonicBlockchainTransfer(requestBody: TransferSonicBlockchain): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     * Invoke a method in a smart contract on Sonic
     * <p><b>2 credits per API call</b></p>
     * <p>Invoke a method in an existing smart contract on Sonic.</p>
     ...
     * @throws ApiError
     */
    static sonicBlockchainSmartContractInvocation(requestBody: (CallSmartContractMethod | CallReadSmartContractMethod | CallSonicSmartContractMethodCaller)): CancelablePromise<(TransactionHash | SignatureId | Data)>;
    /**
     * Broadcast signed Sonic transaction
     * <p><b>2 credits per API call</b></p>
     * <p>Broadcast signed transaction to Sonic blockchain. This method is used internally from Tatum KMS or Tatum client libraries.
     ...
     * @throws ApiError
     */
    static sonicBroadcast(requestBody: BroadcastKMS): CancelablePromise<TransactionHash>;
}
