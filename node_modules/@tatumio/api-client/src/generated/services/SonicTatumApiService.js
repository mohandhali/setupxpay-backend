...
exports.SonicTatumApiService = void 0;
const request_1 = require("../core/request");
class SonicTatumApiService {
    /**
     ...
     * @throws ApiError
     */
    static sonicGenerateWallet(mnemonic) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/sonic/wallet`,
            query: {
                'mnemonic': mnemonic,
            },
            errors: {
     ...
     * @throws ApiError
     */
    static sonicGenerateAddress(xpub, index) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/sonic/address/${xpub}/${index}`,
            errors: {
                400: `Bad Request. Validation failed for the given object in the HTTP Body or Request parameters.`,
                401: `Unauthorized. Not valid or inactive subscription key present in the HTTP Header.`,
                500: `Internal server error. There was an error on the server during the processing of the request.`,
     ...
     * @throws ApiError
     */
    static sonicGenerateAddressPrivateKey(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/sonic/wallet/priv`,
            body: requestBody,
     ...
     * @throws ApiError
     */
    static sonicWeb3Driver(xApiKey, requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/sonic/web3/${xApiKey}`,
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request. Validation failed for the given object in the HTTP Body or Request parameters.`,
     ...
     * @throws ApiError
     */
    static sonicGetCurrentBlock() {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/sonic/block/current`,
            errors: {
                401: `Unauthorized. Not valid or inactive subscription key present in the HTTP Header.`,
                500: `Internal server error. There was an error on the server during the processing of the request.`,
            },
     ...
     * @throws ApiError
     */
    static sonicGetBlock(hash) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/sonic/block/${hash}`,
            errors: {
                400: `Bad Request. Validation failed for the given object in the HTTP Body or Request parameters.`,
                401: `Unauthorized. Not valid or inactive subscription key present in the HTTP Header.`,
                500: `Internal server error. There was an error on the server during the processing of the request.`,
     ...
     * @throws ApiError
     */
    static sonicGetBalance(address) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/sonic/account/balance/${address}`,
            errors: {
                400: `Bad Request. Validation failed for the given object in the HTTP Body or Request parameters.`,
                401: `Unauthorized. Not valid or inactive subscription key present in the HTTP Header.`,
                500: `Internal server error. There was an error on the server during the processing of the request.`,
     ...
     * @throws ApiError
     */
    static sonicGetTransaction(hash) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/sonic/transaction/${hash}`,
            errors: {
                400: `Bad Request. Validation failed for the given object in the HTTP Body or Request parameters.`,
                401: `Unauthorized. Not valid or inactive subscription key present in the HTTP Header.`,
     ...
     * @throws ApiError
     */
    static sonicGetTransactionCount(address) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/sonic/transaction/count/${address}`,
            errors: {
                400: `Bad Request. Validation failed for the given object in the HTTP Body or Request parameters.`,
                401: `Unauthorized. Not valid or inactive subscription key present in the HTTP Header.`,
                500: `Internal server error. There was an error on the server during the processing of the request.`,
     ...
     * @throws ApiError
     */
    static sonicBlockchainTransfer(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/sonic/transaction`,
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request. Validation failed for the given object in the HTTP Body or Request parameters.`,
     ...
     * @throws ApiError
     */
    static sonicBlockchainSmartContractInvocation(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/sonic/smartcontract`,
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request. Validation failed for the given object in the HTTP Body or Request parameters.`,
     ...
     * @throws ApiError
     */
    static sonicBroadcast(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/sonic/broadcast`,
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request. Validation failed for the given object in the HTTP Body or Request parameters.`,
...
exports.SonicTatumApiService = SonicTatumApiService;
//# sourceMappingURL=SonicTatumApiService.js.map