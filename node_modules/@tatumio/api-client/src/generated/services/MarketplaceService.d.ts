...
export declare class MarketplaceService {
     ...
     * @throws ApiError
     */
    static generateMarketplace(requestBody: (GenerateMarketplace | GenerateMarketplaceKMS | GenerateMarketplaceCelo | GenerateMarketplaceCeloKMS | GenerateMarketplaceSolana | GenerateMarketplaceSolanaKMS)): CancelablePromise<(TransactionHash | SolanaMarketplaceTransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static updateMarketplace(requestBody: (UpdateMarketplaceSolana | UpdateMarketplaceSolanaKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static sellAssetOnMarketplace(requestBody: (SellAssetOnMarketplace | SellAssetOnMarketplaceKMS | SellAssetOnMarketplaceCelo | SellAssetOnMarketplaceCeloKMS | SellAssetOnMarketplaceSolana | SellAssetOnMarketplaceSolanaKMS)): CancelablePromise<(TransactionHash | SignatureId | SolanaMarketplaceSellTransactionHash)>;
    /**
     ...
     * @throws ApiError
     */
    static buyAssetOnMarketplace(requestBody: (BuyAssetOnMarketplace | BuyAssetOnMarketplaceKMS | BuyAssetOnMarketplaceCelo | BuyAssetOnMarketplaceCeloKMS | BuyAssetOnMarketplaceSolana | BuyAssetOnMarketplaceSolanaKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static cancelSellMarketplaceListing(requestBody: (CancelSellAssetOnMarketplace | CancelSellAssetOnMarketplaceKMS | CancelSellAssetOnMarketplaceCelo | CancelSellAssetOnMarketplaceCeloKMS | CancelSellAssetOnMarketplaceSolana | CancelSellAssetOnMarketplaceSolanaKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static getMarketplaceListings(chain: 'CELO' | 'ETH' | 'MATIC' | 'SOL', contractAddress: string, type: 'INITIATED' | 'SOLD' | 'CANCELLED'): CancelablePromise<Array<string>>;
    /**
     ...
     * @throws ApiError
     */
    static getMarketplaceListing(chain: 'ETH' | 'ONE' | 'CELO' | 'MATIC' | 'BSC' | 'KLAY' | 'SOL', contractAddress: string, id: string): CancelablePromise<(EvmListingData | SolanaListingData)>;
    /**
     ...
     * @throws ApiError
     */
    static getMarketplaceInfo(chain: 'SOL', contractAddress: string): CancelablePromise<{
        /**
         * Fee Account Address
         */
        feeAccount: string;
     ...
     * @throws ApiError
     */
    static getMarketplaceFee(chain: 'ETH' | 'ONE' | 'CELO' | 'MATIC' | 'BSC' | 'KLAY' | 'SOL', contractAddress: string): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static getMarketplaceFeeRecipient(chain: 'ETH' | 'ONE' | 'CELO' | 'MATIC' | 'BSC' | 'KLAY' | 'SOL', contractAddress: string): CancelablePromise<{
        /**
     ...
     * @throws ApiError
     */
    static updateFeeRecipient(requestBody: (UpdateFeeRecipient | UpdateFeeRecipientKMS | UpdateFeeRecipientCelo | UpdateFeeRecipientCeloKMS | UpdateFeeRecipientSolana | UpdateFeeRecipientSolanaKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static updateFee(requestBody: (UpdateFee | UpdateFeeKMS | UpdateFeeCelo | UpdateFeeCeloKMS | UpdateFeeSolana | UpdateFeeSolanaKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static withdrawFeeFromMarketplace(requestBody: (WithdrawFromMarketplaceSolana | WithdrawFromMarketplaceSolanaKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static withdrawTreasuryFromMarketplace(requestBody: (WithdrawFromMarketplaceSolana | WithdrawFromMarketplaceSolanaKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
}
