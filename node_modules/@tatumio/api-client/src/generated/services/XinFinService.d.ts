...
export declare class XinFinService {
    /**
     * Generate XDC wallet
     ...
     * @throws ApiError
     */
    static xdcGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static xdcGenerateAddress(xpub: string, index: number): CancelablePromise<{
        /**
         * XDC address
         */
        address?: string;
     ...
     * @throws ApiError
     */
    static xdcGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     * @deprecated
     * Web3 HTTP driver
     ...
     * @throws ApiError
     */
    static xdcWeb3Driver(xApiKey: string, requestBody: any): CancelablePromise<any>;
    /**
     ...
     * @throws ApiError
     */
    static xdcGetCurrentBlock(): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static xdcGetBlock(hash: string): CancelablePromise<XdcBlock>;
    /**
     ...
     * @throws ApiError
     */
    static xdcGetBalance(address: string): CancelablePromise<{
        /**
         * Balance in XDC
         */
        balance?: string;
     ...
     * @throws ApiError
     */
    static xdcGetTransaction(hash: string): CancelablePromise<XdcTx>;
    /**
     ...
     * @throws ApiError
     */
    static xdcGetTransactionCount(address: string): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static xdcBlockchainTransfer(requestBody: (TransferXdcBlockchain | TransferXdcBlockchainKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static xdcBlockchainSmartContractInvocation(requestBody: (CallXdcReadSmartContractMethod | CallXdcSmartContractMethod | CallXdcSmartContractMethodKMS)): CancelablePromise<(TransactionHash | SignatureId | Data)>;
    /**
     ...
     * @throws ApiError
     */
    static xdcBroadcast(requestBody: BroadcastKMS): CancelablePromise<TransactionHash>;
}
