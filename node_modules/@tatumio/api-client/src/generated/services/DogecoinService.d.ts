...
export declare class DogecoinService {
     ...
     * @throws ApiError
     */
    static dogeGetTxByAddress(address: string, pageSize: number, offset?: number, blockFrom?: number, blockTo?: number, txType?: 'incoming' | 'outgoing'): CancelablePromise<Array<DogeTxByAddress>>;
    /**
