...
export declare class MultiTokensErc1155OrCompatibleService {
     ...
     * @throws ApiError
     */
    static deployMultiToken(requestBody: (DeployMultiToken | DeployMultiTokenKMS | DeployMultiTokenCelo | DeployMultiTokenCeloKMS), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     * Mint a Multi Token
     * <p><b>2 credits per API call</b></p>
     ...
     * @throws ApiError
     */
    static mintMultiToken(requestBody: (MintMultiToken | MintMultiTokenKMS | MintMultiTokenCelo | MintMultiTokenKMSCelo), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static mintMultiTokenBatch(requestBody: (MintMultiTokenBatch | MintMultiTokenBatchKMS | MintMultiTokenBatchCelo | MintMultiTokenBatchKMSCelo), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     * Burn a Multi Token
     * <p><b>2 credits per API call</b></p>
     ...
     * @throws ApiError
     */
    static burnMultiToken(requestBody: (BurnMultiToken | BurnMultiTokenKMS | BurnMultiTokenCelo | BurnMultiTokenKMSCelo), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static burnMultiTokenBatch(requestBody: (BurnMultiTokenBatch | BurnMultiTokenBatchKMS | BurnMultiTokenBatchCelo | BurnMultiTokenBatchKMSCelo), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static transferMultiToken(requestBody: (TransferMultiToken | TransferMultiTokenCelo | TransferMultiTokenKMS | TransferMultiTokenKMSCelo), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static transferMultiTokenBatch(requestBody: (TransferMultiTokenBatch | TransferMultiTokenBatchKMS | TransferMultiTokenBatchCelo | TransferMultiTokenBatchKMSCelo), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static addMultiTokenMinter(requestBody: (AddMultiTokenMinter | AddMultiTokenMinterKMS), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static multiTokenGetTransaction(chain: 'ETH' | 'MATIC' | 'KCS' | 'KLAY' | 'ONE' | 'CELO' | 'BSC' | 'FLR' | 'CRO' | 'BASE' | 'AVAX' | 'FTM' | 'OPTIMISM', hash: string, testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(CeloTx | EthTx)>;
    /**
     ...
     * @throws ApiError
     */
    static multiTokenGetBalance(chain: 'ETH' | 'MATIC' | 'KCS' | 'KLAY' | 'ONE' | 'CELO' | 'BSC' | 'FLR' | 'CRO' | 'BASE' | 'AVAX' | 'FTM' | 'OPTIMISM', address: string, contractAddress: string, tokenId: string, testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<{
        /**
     ...
     * @throws ApiError
     */
    static multiTokenGetBalanceBatch(chain: 'ETH' | 'MATIC' | 'KCS' | 'KLAY' | 'ONE' | 'CELO' | 'BSC' | 'FLARE' | 'CRO' | 'BASE' | 'AVAX' | 'FTM' | 'OPTIMISM', contractAddress: string, tokenId: string, address: string, testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<Array<string>>;
    /**
     ...
     * @throws ApiError
     */
    static multiTokenGetMetadata(chain: 'ETH' | 'MATIC' | 'KCS' | 'KLAY' | 'ONE' | 'CELO' | 'BSC' | 'FLR' | 'CRO' | 'BASE' | 'AVAX' | 'FTM' | 'OPTIMISM', token: string, contractAddress: string, testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<{
        /**
