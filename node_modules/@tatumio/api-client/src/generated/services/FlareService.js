...
class FlareService {
     ...
     * @throws ApiError
     */
    static flareGenerateWallet(mnemonic, testnetType, xTestnetType) {
     ...
     * @throws ApiError
     */
    static flareGenerateAddress(xpub, index, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static flareGenerateAddressPrivateKey(requestBody, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static flareWeb3Driver(xApiKey, requestBody, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static flareGetCurrentBlock(testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static flareGetBlock(hash, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static flareGetBalance(address, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static flareGetTransaction(hash, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static flareGetTransactionCount(address, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static flareBlockchainTransfer(requestBody, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static flareBlockchainSmartContractInvocation(requestBody, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static flareBroadcast(requestBody, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'POST',
...
exports.FlareService = FlareService;
//# sourceMappingURL=FlareService.js.map