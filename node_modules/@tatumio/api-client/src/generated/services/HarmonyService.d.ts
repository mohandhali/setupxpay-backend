...
export declare class HarmonyService {
     ...
     * @throws ApiError
     */
    static oneGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static oneGenerateAddress(xpub: string, index: number): CancelablePromise<GeneratedAddressOne>;
    /**
     ...
     * @throws ApiError
     */
    static oneFormatAddress(address: string): CancelablePromise<GeneratedAddressOne>;
    /**
     ...
     * @throws ApiError
     */
    static oneGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     * @deprecated
     * Web3 HTTP driver
     ...
     * @throws ApiError
     */
    static oneWeb3Driver(xApiKey: string, requestBody: any, shardId?: number): CancelablePromise<any>;
    /**
     ...
     * @throws ApiError
     */
    static oneGetCurrentBlock(): CancelablePromise<Array<OneBlockCurrent>>;
    /**
     ...
     * @throws ApiError
     */
    static oneGetBlock(hash: string, shardId?: number): CancelablePromise<EthBlock>;
    /**
     ...
     * @throws ApiError
     */
    static oneGetBalance(address: string, shardId?: number): CancelablePromise<OneBalance>;
    /**
     * Get ONE Transaction
     * <p><b>2 credits per API call</b></p>
     ...
     * @throws ApiError
     */
    static oneGetTransaction(hash: string, shardId?: number): CancelablePromise<OneTx>;
    /**
     ...
     * @throws ApiError
     */
    static oneGetTransactionCount(address: string, shardId?: number): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static oneBlockchainTransfer(requestBody: (TransferOneBlockchain | TransferOneBlockchainKMS), shardId?: number): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static oneBlockchainSmartContractInvocation(requestBody: (CallOneReadSmartContractMethod | CallOneSmartContractMethod | CallOneSmartContractMethodKMS), shardId?: number): CancelablePromise<(TransactionHash | SignatureId | Data)>;
    /**
     ...
     * @throws ApiError
     */
    static oneBroadcast(requestBody: BroadcastKMS, shardId?: number): CancelablePromise<TransactionHash>;
}
