...
export declare class EthereumService {
     ...
     * @throws ApiError
     */
    static ethGenerateWallet(mnemonic?: string, testnetType?: EthTestnetType, xTestnetType?: EthTestnetType): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static ethGenerateAddress(xpub: string, index: number, testnetType?: EthTestnetType, xTestnetType?: EthTestnetType): CancelablePromise<GeneratedAddressEth>;
    /**
     ...
     * @throws ApiError
     */
    static ethGenerateAddressPrivateKey(requestBody: PrivKeyRequest, testnetType?: EthTestnetType, xTestnetType?: EthTestnetType): CancelablePromise<PrivKey>;
    /**
     * @deprecated
     * Web3 HTTP driver
     ...
     * @throws ApiError
     */
    static ethWeb3Driver(xApiKey: string, requestBody: any, testnetType?: EthTestnetType, xTestnetType?: EthTestnetType): CancelablePromise<any>;
    /**
     ...
     * @throws ApiError
     */
    static ethGetCurrentBlock(testnetType?: EthTestnetType, xTestnetType?: EthTestnetType): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static ethGetBlock(hash: string, testnetType?: EthTestnetType, xTestnetType?: EthTestnetType): CancelablePromise<EthBlock>;
    /**
     ...
     * @throws ApiError
     */
    static ethGetBalance(address: string, testnetType?: EthTestnetType, xTestnetType?: EthTestnetType): CancelablePromise<EthBalance>;
    /**
     ...
     * @throws ApiError
     */
    static ethGetTransaction(hash: string, testnetType?: EthTestnetType, xTestnetType?: EthTestnetType): CancelablePromise<EthTx>;
    /**
     ...
     * @throws ApiError
     */
    static ethGetTransactionCount(address: string, testnetType?: EthTestnetType, xTestnetType?: EthTestnetType): CancelablePromise<number>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static ethBlockchainTransfer(requestBody: (TransferEthBlockchain | TransferEthBlockchainKMS), testnetType?: EthTestnetType, xTestnetType?: EthTestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static ethBlockchainSmartContractInvocation(requestBody: (CallSmartContractMethod | CallReadSmartContractMethod | CallEthSmartContractMethodCaller | CallSmartContractMethodKMS), testnetType?: EthTestnetType, xTestnetType?: EthTestnetType): CancelablePromise<(TransactionHash | SignatureId | Data)>;
    /**
     ...
     * @throws ApiError
     */
    static ethBroadcast(requestBody: BroadcastKMS, testnetType?: EthTestnetType, xTestnetType?: EthTestnetType): CancelablePromise<TransactionHash>;
}
