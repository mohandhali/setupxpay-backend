...
export declare class BaseService {
     ...
     * @throws ApiError
     */
    static baseGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static baseGenerateAddress(xpub: string, index: number): CancelablePromise<GeneratedAddressBase>;
    /**
     ...
     * @throws ApiError
     */
    static baseGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     * @deprecated
     * Web3 HTTP driver
     ...
     * @throws ApiError
     */
    static baseWeb3Driver(xApiKey: string, requestBody: any): CancelablePromise<any>;
    /**
     ...
     * @throws ApiError
     */
    static baseGetCurrentBlock(): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static baseGetBlock(hash: string): CancelablePromise<BaseBlock>;
    /**
     ...
     * @throws ApiError
     */
    static baseGetBalance(address: string): CancelablePromise<BaseBalance>;
    /**
     ...
     * @throws ApiError
     */
    static baseGetTransaction(hash: string): CancelablePromise<BaseTx>;
    /**
     ...
     * @throws ApiError
     */
    static baseGetTransactionCount(address: string): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static baseBlockchainTransfer(requestBody: (TransferBaseBlockchain | TransferBaseBlockchainKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static baseBlockchainSmartContractInvocation(requestBody: (CallSmartContractMethod | CallReadSmartContractMethod | CallBaseSmartContractMethodCaller | CallSmartContractMethodKMS)): CancelablePromise<(TransactionHash | SignatureId | Data)>;
    /**
     ...
     * @throws ApiError
     */
    static baseBroadcast(requestBody: BroadcastKMS): CancelablePromise<TransactionHash>;
}
