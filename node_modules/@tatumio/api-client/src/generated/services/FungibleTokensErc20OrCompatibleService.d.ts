...
export declare class FungibleTokensErc20OrCompatibleService {
     ...
     * @throws ApiError
     */
    static erc20Mint(requestBody: (ChainMintErc20 | ChainMintErc20KMS | ChainMintKcsErc20 | ChainMintKcsErc20KMS | ChainMintCeloErc20 | ChainMintCeloErc20KMS), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static erc20Burn(requestBody: (ChainBurnErc20 | ChainBurnErc20KMS | ChainBurnKcsErc20 | ChainBurnKcsErc20KMS | ChainBurnCeloErc20 | ChainBurnCeloErc20KMS | ChainBurnAlgoErc20 | ChainBurnAlgoErc20KMS), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static erc20Approve(requestBody: (ApproveErc20 | ApproveErc20KMS | ApproveCeloErc20 | ApproveCeloErc20KMS), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static erc20Transfer(requestBody: (ChainTransferEthErc20 | ChainTransferSolanaSpl | ChainTransferBscBep20 | ChainTransferCeloErc20Token | ChainTransferAlgoErc20 | ChainTransferKcsEthErc20 | ChainTransferEthErc20KMS | ChainTransferSolanaSplKMS | ChainTransferBscBep20KMS | ChainTransferCeloErc20TokenKMS | ChainTransferAlgoErc20KMS | ChainTransferKcsEthErc20KMS), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static erc20GetBalance(chain: 'CELO' | 'ALGO' | 'MATIC' | 'ETH' | 'BSC' | 'XDC' | 'KLAY' | 'ONE' | 'EGLD' | 'KCS' | 'SOL' | 'FLR' | 'CRO' | 'BASE' | 'AVAX' | 'FTM' | 'OPTIMISM', address: string, contractAddress: string, testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<Erc20Balance>;
    /**
