...
export declare class NftErc721OrCompatibleService {
     ...
     * @throws ApiError
     */
    static nftDeployErc721(requestBody: (DeployNft | DeployNftCelo | DeployNftTron | DeployNftKMS | DeployNftCeloKMS | DeployNftTronKMS | DeployNftFlowPK | DeployNftFlowMnemonic | DeployNftTezos), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static nftAddMinter(requestBody: (AddNftMinter | AddNftMinterKMS), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     * Mint an NFT
     * <p><b>100 credits per API call on Flow<br/>
     * 2 credits per API call on the other blockchains</b></p>
     ...
     * {
         ...
         * {
             ...
             * @throws ApiError
             */
    static nftMintErc721(requestBody: (MintNftExpress | MintNftExpressAlgorand | MintNftExpressSolana | MintNftTezos | MintNftExpressTezos | MintNftMinter | MintNft | MintNftKMS | MintNftAlgorand | MintNftAlgorandKMS | MintNftCelo | MintNftKMSCelo | MintNftFlowPK | MintNftFlowMnemonic | MintNftFlowKMS | MintNftSolana | MintNftSolanaKMS | MintNftTron | MintNftKMSTron | MintNftKadena), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | FlowMintedResult | SolanaMintedResult | AlgorandMintedResult | SignatureId)>;
    /**
     * Transfer an NFT
     * <p><b>100 credits per API call on Flow<br/>
     * 2 credits per API call on the other blockchains</b></p>
     ...
     * @throws ApiError
     */
    static nftTransferErc721(requestBody: (TransferNft | TransferNftCelo | TransferNftTron | TransferNftSolana | TransferNftAlgo | TransferNftAlgoExpress | TransferNftFlowPK | TransferNftFlowMnemonic | TransferNftTezos | TransferNftKMS | TransferNftKMSCelo | TransferNftAlgoKMS | TransferNftSolanaKMS | TransferNftFlowKMS | TransferNftKMSTron), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     * Mint multiple NFTs
     * <p><b>100 credits per API call on Flow<br/>
     * 2 credits per API call on the other blockchains</b></p>
     ...
     * @throws ApiError
     */
    static nftBurnErc721(requestBody: (BurnNft | BurnNftCelo | BurnNftAlgo | BurnNftTezos | BurnNftKMSCelo | BurnNftTron | BurnNftSolana | BurnNftSolanaKMS | BurnNftKMSTron | BurnNftKMS | BurnNftAlgoKMS | BurnNftFlowPK | BurnNftFlowMnemonic | BurnNftFlowKMS | BurnNftKadena), testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static nftGetTransactErc721(chain: 'ETH' | 'MATIC' | 'KCS' | 'ONE' | 'KLAY' | 'CELO' | 'TRON' | 'FLOW' | 'BSC' | 'FLR' | 'CRO' | 'BASE' | 'AVAX' | 'FTM' | 'OPTIMISM', hash: string, testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(CeloTx | EthTx | FlowTx)>;
    /**
     ...
     * @throws ApiError
     */
    static nftGetBalanceErc721(chain: 'ETH' | 'MATIC' | 'KCS' | 'ONE' | 'KLAY' | 'CELO' | 'TRON' | 'FLOW' | 'BSC' | 'SOL' | 'ALGO' | 'EGLD' | 'FLR' | 'CRO' | 'BASE' | 'AVAX' | 'FTM' | 'OPTIMISM', address: string, contractAddress: string, testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(NftGetBalanceScAlgo | NftGetBalanceSc)>;
    /**
     * Get NFT metadata
     * <p><b>1 credit per API call</b></p>
     ...
     * @throws ApiError
     */
    static nftGetMetadataErc721(chain: 'BSC' | 'CELO' | 'ETH' | 'FLOW' | 'KCS' | 'KLAY' | 'MATIC' | 'ONE' | 'SOL' | 'TRON' | 'ALGO' | 'FLR' | 'CRO' | 'BASE' | 'AVAX' | 'FTM' | 'OPTIMISM', contractAddress: string, tokenId: string, account?: string, testnetType?: TestnetType, xTestnetType?: TestnetType): CancelablePromise<(NftMetadataErc721 | NftMetadataErc721OnchainSolana | NftMetadataErc721OnchainFlow | NftMetadataErc721OnchainAlgo)>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static nftGetContractAddress(chain: 'ALGO' | 'ETH' | 'ONE' | 'KLAY' | 'CELO' | 'TRON' | 'FLOW' | 'MATIC' | 'KCS' | 'BSC' | 'FLR' | 'CRO' | 'BASE' | 'AVAX' | 'FTM' | 'OPTIMISM', hash: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<{
        /**
