...
export declare class KlaytnService {
    /**
     ...
     * @throws ApiError
     */
    static klaytnGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static klaytnGenerateAddress(xpub: string, index: number): CancelablePromise<{
        /**
         * Klaytn address
         */
        address?: string;
     ...
     * @throws ApiError
     */
    static klaytnGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     * @deprecated
     * Web3 HTTP driver
     ...
     * @throws ApiError
     */
    static klaytnWeb3Driver(xApiKey: string, requestBody: any): CancelablePromise<any>;
    /**
     ...
     * @throws ApiError
     */
    static klaytnGetCurrentBlock(): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static klaytnGetBlock(hash: string): CancelablePromise<KlaytnBlock>;
    /**
     ...
     * @throws ApiError
     */
    static klaytnGetBalance(address: string): CancelablePromise<{
        /**
         * Balance in KLAY
         */
        balance?: string;
     ...
     * @throws ApiError
     */
    static klaytnGetTransaction(hash: string): CancelablePromise<KlaytnTx>;
    /**
     ...
     * @throws ApiError
     */
    static klaytnGetTransactionCount(address: string): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static klaytnBlockchainTransfer(requestBody: (TransferKlaytnBlockchain | TransferKlaytnBlockchainKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static klaytnBlockchainSmartContractInvocation(requestBody: (CallKlaytnSmartContractReadMethod | CallKlaytnSmartContractMethod | CallKlaytnSmartContractMethodKMS)): CancelablePromise<(TransactionHash | SignatureId | Data)>;
    /**
     ...
     * @throws ApiError
     */
    static klaytnBroadcast(requestBody: BroadcastKMS): CancelablePromise<TransactionHash>;
}
