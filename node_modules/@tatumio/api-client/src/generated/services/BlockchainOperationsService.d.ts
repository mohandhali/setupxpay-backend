...
export declare class BlockchainOperationsService {
     ...
     * @throws ApiError
     */
    static adaTransferOffchain(requestBody: (TransferAdaMnemonic | TransferAdaKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
