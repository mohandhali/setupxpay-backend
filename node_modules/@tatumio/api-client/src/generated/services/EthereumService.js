...
class EthereumService {
     ...
     * @throws ApiError
     */
    static ethGenerateWallet(mnemonic, testnetType, xTestnetType) {
     ...
     * @throws ApiError
     */
    static ethGenerateAddress(xpub, index, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ethGenerateAddressPrivateKey(requestBody, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static ethWeb3Driver(xApiKey, requestBody, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static ethGetCurrentBlock(testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ethGetBlock(hash, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ethGetBalance(address, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ethGetTransaction(hash, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ethGetTransactionCount(address, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ethBlockchainTransfer(requestBody, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static ethBlockchainSmartContractInvocation(requestBody, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static ethBroadcast(requestBody, testnetType, xTestnetType) {
        return (0, request_1.request)({
            method: 'POST',
