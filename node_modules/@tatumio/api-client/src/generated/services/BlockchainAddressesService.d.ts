...
export declare class BlockchainAddressesService {
    /**
     ...
     * @throws ApiError
     */
    static generateDepositAddress(id: string, index?: number): CancelablePromise<Address>;
    /**
     ...
     * @throws ApiError
     */
    static getAllDepositAddresses(id: string): CancelablePromise<Array<Address>>;
    /**
     ...
     * @throws ApiError
     */
    static generateDepositAddressesBatch(requestBody: OffchainAddresses): CancelablePromise<Array<Address>>;
    /**
     ...
     * @throws ApiError
     */
    static addressExists(currency: string, address: string, index?: number): CancelablePromise<Account>;
    /**
     ...
     * @throws ApiError
     */
    static assignAddress(id: string, address: string, index?: number): CancelablePromise<Address>;
    /**
     ...
     * @throws ApiError
     */
    static removeAddress(id: string, address: string, index?: number): CancelablePromise<void>;
}
