...
export declare class BitcoinService {
     ...
     * @throws ApiError
     */
    static btcGetTxByAddress(address: string, pageSize: number, offset?: number, blockFrom?: number, blockTo?: number, txType?: 'incoming' | 'outgoing'): CancelablePromise<Array<BtcTx>>;
    /**
     ...
     * @throws ApiError
     */
    static btcGetTxByAddressBatch(requestBody?: BtcGetTxByAddressBatch): CancelablePromise<Array<{
        /**
         * Address
         */
        address?: string;
