...
exports.OptimismService = void 0;
...
class OptimismService {
     ...
     * @throws ApiError
     */
    static optimismGenerateWallet(mnemonic) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/optimism/wallet`,
            query: {
                'mnemonic': mnemonic,
            },
            errors: {
     ...
     * @throws ApiError
     */
    static optimismGenerateAddress(xpub, index) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/optimism/address/${xpub}/${index}`,
            errors: {
                400: `Bad Request`,
                401: `Unauthorized. Not valid or inactive subscription key present in the HTTP Header.`,
                500: `Internal server error. There was an error on the server during the processing of the request.`,
     ...
     * @throws ApiError
     */
    static optimismGenerateAddressPrivateKey(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/optimism/wallet/priv`,
            body: requestBody,
     ...
     * @throws ApiError
     */
    static optimismWeb3Driver(xApiKey, requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/optimism/web3/${xApiKey}`,
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * @throws ApiError
     */
    static optimismGetCurrentBlock() {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/optimism/block/current`,
            errors: {
                401: `Unauthorized. Not valid or inactive subscription key present in the HTTP Header.`,
                500: `Internal server error. There was an error on the server during the processing of the request.`,
            },
     ...
     * @throws ApiError
     */
    static optimismGetBlock(hash) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/optimism/block/${hash}`,
            errors: {
                400: `Bad Request`,
                401: `Unauthorized. Not valid or inactive subscription key present in the HTTP Header.`,
                500: `Internal server error. There was an error on the server during the processing of the request.`,
     ...
     * @throws ApiError
     */
    static optimismGetBalance(address) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/optimism/account/balance/${address}`,
            errors: {
                400: `Bad Request`,
                401: `Unauthorized. Not valid or inactive subscription key present in the HTTP Header.`,
                500: `Internal server error. There was an error on the server during the processing of the request.`,
     ...
     * @throws ApiError
     */
    static optimismGetTransaction(hash) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/optimism/transaction/${hash}`,
            errors: {
                400: `Bad Request`,
                401: `Unauthorized. Not valid or inactive subscription key present in the HTTP Header.`,
     ...
     * @throws ApiError
     */
    static optimismGetTransactionCount(address) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/optimism/transaction/count/${address}`,
            errors: {
                400: `Bad Request`,
                401: `Unauthorized. Not valid or inactive subscription key present in the HTTP Header.`,
                500: `Internal server error. There was an error on the server during the processing of the request.`,
     ...
     * @throws ApiError
     */
    static optimismBlockchainTransfer(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/optimism/transaction`,
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * @throws ApiError
     */
    static optimismBlockchainSmartContractInvocation(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/optimism/smartcontract`,
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * @throws ApiError
     */
    static optimismBroadcast(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/optimism/broadcast`,
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
...
exports.OptimismService = OptimismService;
//# sourceMappingURL=OptimismService.js.map