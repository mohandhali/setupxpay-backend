...
export declare class FantomService {
    /**
     ...
     * @throws ApiError
     */
    static fantomGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static fantomGenerateAddress(xpub: string, index: number): CancelablePromise<GeneratedAddressFantom>;
    /**
     ...
     * @throws ApiError
     */
    static fantomGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     * @deprecated
     * Web3 HTTP driver
     ...
     * @throws ApiError
     */
    static fantomWeb3Driver(xApiKey: string, requestBody: any): CancelablePromise<any>;
    /**
     ...
     * @throws ApiError
     */
    static fantomGetCurrentBlock(): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static fantomGetBlock(hash: string): CancelablePromise<FantomBlock>;
    /**
     ...
     * @throws ApiError
     */
    static fantomGetBalance(address: string): CancelablePromise<FantomBalance>;
    /**
     ...
     * @throws ApiError
     */
    static fantomGetTransaction(hash: string): CancelablePromise<FantomTx>;
    /**
     ...
     * @throws ApiError
     */
    static fantomGetTransactionCount(address: string): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static fantomBlockchainTransfer(requestBody: (TransferFantomBlockchain | TransferFantomBlockchainKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static fantomBlockchainSmartContractInvocation(requestBody: (CallSmartContractMethod | CallReadSmartContractMethod | CallFantomSmartContractMethodCaller | CallSmartContractMethodKMS)): CancelablePromise<(TransactionHash | SignatureId | Data)>;
    /**
     ...
     * @throws ApiError
     */
    static fantomBroadcast(requestBody: BroadcastKMS): CancelablePromise<TransactionHash>;
}
