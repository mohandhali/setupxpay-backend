...
export declare class BlockchainUtilsService {
     ...
     * @throws ApiError
     */
    static scGetContractAddress(chain: 'ALGO' | 'BSC' | 'CELO' | 'EGLD' | 'ETH' | 'FLOW' | 'KLAY' | 'KCS' | 'MATIC' | 'ONE' | 'TRON' | 'XDC', hash: string): CancelablePromise<{
        /**
     ...
     * @throws ApiError
     */
    static getAuctionEstimatedTime(chain: 'BSC' | 'CELO' | 'ETH' | 'KLAY' | 'MATIC' | 'ONE', date: string): CancelablePromise<number>;
}
