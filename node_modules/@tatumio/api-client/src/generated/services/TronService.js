...
class TronService {
     ...
     * @throws ApiError
     */
    static tronAccountTx(address, next, onlyConfirmed, onlyUnconfirmed, onlyTo, onlyFrom, orderBy, minTimestamp, maxTimestamp) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static tronAccountTx20(address, next, onlyConfirmed, onlyUnconfirmed, onlyTo, onlyFrom, orderBy, minTimestamp, maxTimestamp, contractAddress) {
        return (0, request_1.request)({
            method: 'GET',
