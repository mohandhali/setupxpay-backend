import { CancelablePromise, CreateRecord, CreateRecordCelo, TransactionHash } from '@tatumio/api-client';
import { Blockchain } from '@tatumio/shared-core';
export declare type RequestBody = CreateRecord | CreateRecordCelo;
export declare type RequestBodyWithoutChain = Omit<CreateRecord, 'chain'> | Omit<CreateRecordCelo, 'chain'>;
export declare const evmBlockchainRecord: (args: {
