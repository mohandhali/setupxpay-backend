...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-50 to-blue-100">
      {/* Header: User name only, no email, no extra background */}
      <div className="w-full flex items-center justify-between px-4 py-4 sticky top-0 z-50">
      ...
      <div className="max-w-md mx-auto px-4 mt-8 animate-fadeIn">
      ...
      {/* Main Actions (Wallet, Transactions, Community) */}
      <div className="max-w-md mx-auto grid grid-cols-3 gap-4 mb-6 px-4">
        <button
          onClick={() => setShowWalletModal(true)}
          className="bg-white border border-blue-100 text-blue-900 rounded-2xl py-4 flex flex-col items-center shadow hover:bg-blue-50 transition"
        >
      ...
      <div className="bg-white border rounded-2xl shadow-md p-5 mx-4 mb-24 space-y-4 max-w-md mx-auto">
      ...
      {/* Footer Actions - Clean, professional, single row, like main actions above */}
      <div className="fixed bottom-0 left-0 w-full flex justify-center items-center py-4 z-50" style={{ background: 'transparent' }}>
        <div className="flex gap-4 max-w-md w-full justify-center items-center px-4">
          <button
            onClick={() => setShowBuyUSDT(true)}
            className="flex flex-col items-center justify-center bg-white border border-blue-100 text-blue-900 rounded-2xl py-3 px-2 w-24 shadow hover:bg-blue-50 transition text-xs font-semibold"
          >
